...
class Ui_MainWindow(object):
    def __init__(self, MainWindow):
        ...
        self.listWidget.setMinimumSize(300, 1000)
        self.listWidget.setObjectName("listWidget")

        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.layout.addWidget(self.scrollArea, alignment=QtCore.Qt.AlignLeft)

        self.scrollArea_2 = QtWidgets.QScrollArea(self.central_widget)
        self.scrollArea_2.setMinimumWidth(300)
        ...
        self.listWidget_2 = QtWidgets.QTreeWidget(
            self.scrollAreaWidgetContents_2)
        self.listWidget_2.setObjectName("listWidget_2")
        self.listWidget_2.setMinimumSize(300, 1000)
        self.scrollArea_2.setWidget(self.scrollAreaWidgetContents_2)
        self.layout.addWidget(self.scrollArea_2, alignment=QtCore.Qt.AlignLeft)

        self.layout.addLayout(self.sub_layout_1)
        self.layout.addLayout(self.sub_layout_2)
        self.sub_layout_2.addWidget(self.groupBox)
        self.sub_layout_2.addWidget(self.groupBox_2)
        self.sub_layout_2.addWidget(self.pushButton,
        ...
        self.attr_action = QtWidgets.QAction(MainWindow)
    ...
    def re_translate_ui(self, MainWindow):
        ...
        self.checkBox_cleancache.setText(
            _translate("MainWindow", "Clean Cache"))
        ...
        self.plot_action.setText(_translate("MainWindow", "Plot"))
        self.attr_action.setText(_translate("MainWindow", "Detail"))
